...
class CoreNavigator {
  ...
  static void toNamed(String routeName, {BaseScreenParams? arguments, BuildContext? context});

  /// Push a named route onto the navigation stack
  static void pushNamed(String routeName, {BaseScreenParams? arguments, BuildContext? context});
...
The navigation system provides a comprehensive set of animated page transitions including fade, slide, scale, zoom, flip, rotate, bounce, elastic, and crossfade transitions.
