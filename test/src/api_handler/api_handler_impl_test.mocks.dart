...
// in coore/test/src/api_handler/api_handler_impl_test.dart.
...
/// A class which mocks [NetworkExceptionMapper].
///
/// See the documentation for Mockito's code generation for more information.
...
class MockCacheStore extends _i1.Mock implements _i11.CacheStore {
  ...
  @override
  _i9.Future<bool> exists(String? key) =>
      (super.noSuchMethod(
  ...
  @override
  _i9.Future<void> delete(String? key, {bool? staleOnly = false}) =>
      (super.noSuchMethod(
            Invocation.method(#delete, [key], {#staleOnly: staleOnly}),
            returnValue: _i9.Future<void>.value(),
            returnValueForMissingStub: _i9.Future<void>.value(),
          )
          as _i9.Future<void>);
  ...
  @override
  _i9.Future<void> deleteFromPath(
    RegExp? pathPattern, {
    Map<String, String?>? queryParams,
  }) =>
      (super.noSuchMethod(
